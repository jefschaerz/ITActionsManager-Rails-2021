class InterventionTypesController < ApplicationController
  before_action :set_intervention_type, only: %i[ show edit update destroy ]

  # GET /intervention_types or /intervention_types.json
  def index
    @intervention_types = InterventionType.all
  end

  # GET /intervention_types/1 or /intervention_types/1.json
  def show
  end
  ...
  # POST /intervention_types or /intervention_types.json
  def create
  ...
  # PATCH/PUT /intervention_types/1 or /intervention_types/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /intervention_types/1 or /intervention_types/1.json
  def destroy
  ...
  private
    ...
    def intervention_type_params
      params.require(:intervention_type).permit(:description)
    end
end
